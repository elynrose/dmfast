    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-settings.update", [$paymentSetting->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $paymentSetting->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $paymentSetting->phone) }}">
                            @if($errors->has('phone'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="routing" id="routing" value="{{ old('routing', $paymentSetting->routing) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="account" id="account" value="{{ old('account', $paymentSetting->account) }}">

                    ...
                    <form method="POST" action="{{ route("frontend.payment-methods.update", [$paymentMethod->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $paymentMethod->active || old('active', 0) === 1 ? 'checked' : '' }}>
                                <label for="active">{{ trans('cruds.paymentMethod.fields.active') }}</label>
                            </div>

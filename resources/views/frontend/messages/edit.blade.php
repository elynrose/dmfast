                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.messages.update", [$message->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="message" id="message" required>{{ old('message', $message->message) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="closed" id="closed" value="1" {{ $message->closed || old('closed', 0) === 1 ? 'checked' : '' }}>

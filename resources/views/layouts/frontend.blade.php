                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('interval_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.intervals.index') }}">
                                            {{ trans('cruds.interval.title') }}
                                        </a>
                                    @endcan
                                    @can('credit_setting_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.credit-settings.index') }}">
                                    ...
                                    @can('total_credit_access')
                                        <a class="dropdown-item" href="{{ route('frontend.total-credits.index') }}">
                                            {{ trans('cruds.totalCredit.title') }}
                                        </a>
                                    @endcan
                                    @can('withdraw_access')
                                        <a class="dropdown-item" href="{{ route('frontend.withdraws.index') }}">
                                    ...
                                    @endcan
                                    @can('inbox_access')
                                        <a class="dropdown-item" href="{{ route('frontend.inboxes.index') }}">
                                            {{ trans('cruds.inbox.title') }}
                                        </a>
                                    @endcan
                                    @can('payment_setting_access')
                                        <a class="dropdown-item" href="{{ route('frontend.payment-settings.index') }}">

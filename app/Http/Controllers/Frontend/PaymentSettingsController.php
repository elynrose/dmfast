...
class PaymentSettingsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.paymentSettings.index', compact('paymentSettings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.paymentSettings.create', compact('methods', 'users'));
    }
    ...
    public function store(StorePaymentSettingRequest $request)
    {
        ...
        return redirect()->route('frontend.payment-settings.index');
    }
    ...
    public function edit(PaymentSetting $paymentSetting)
    {
        ...
        return view('frontend.paymentSettings.edit', compact('methods', 'paymentSetting', 'users'));
    }
    ...
    public function show(PaymentSetting $paymentSetting)
    {
        ...
        return view('frontend.paymentSettings.show', compact('paymentSetting'));
    }
